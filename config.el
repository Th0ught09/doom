...
(defun calendar-helper () ;; doesn't have to be interactive
  (cfw:open-calendar-buffer
   ...
   (list
    ...
    ; all in agenda(cfw:ical-create-source "Uni" "https://scientia-eu-v4-api-d3-02.azurewebsites.net//api/ical/b5098763-4476-40a6-8d60-5a08e9c52964/33ff0a46-42c9-fa35-e710-20a89e30a8cd/timetable.ics" "Red")
        ...
        (when (string= (org-element-property :language bl) "typst")
            (let* ((start (org-element-property :begin bl))
              ...
              (unless (file-exists-p movefile)
                (with-temp-buffer
                  (insert "#set text(size: 12pt, fill: rgb(\"#ffffff\"))\n#set page(background: rgb(\"fbf1c7\"), width: auto, height: auto, margin: 10pt)\n")
                  (insert value)
