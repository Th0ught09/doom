...
(defgroup cu-doom-gruvbox-light-theme nil
  "Options for the `doom-gruvbox-light' theme."
  :group 'doom-themes)

(defcustom cu-doom-gruvbox-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-gruvbox-light-theme
  :type 'boolean)

(defcustom cu-doom-gruvbox-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-gruvbox-light-theme
  :type 'boolean)

(defcustom cu-doom-gruvbox-light-comment-bg doom-gruvbox-light-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-gruvbox-light-theme
  :type 'boolean)

(defcustom cu-doom-gruvbox-light-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-gruvbox-light-theme
  :type '(choice integer boolean))

(defcustom cu-doom-gruvbox-light-variant nil
...
(def-doom-theme cu-doom-gruvbox-light
  "gruvbox light theme"
  :family 'doom-gruvbox
  :background-mode 'light

  ;; name        default   256       16
   ((bg '("#f2e5bc" "#ffffd7" nil))   ; bg0_s
